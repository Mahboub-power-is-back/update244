...
header
box_title "VLESS • XRAY"
system_info
item 1 "Create VLESS WebSocket account" "$GREEN"
item 2 "Delete VLESS WebSocket account" "$RED"
item 3 "Extend VLESS account active life" "$YELLOW"
item 4 "Check VLESS user login" "$CYAN"
