...
header
box_title "VMESS • XRAY"
system_info
item 1 "Create VMess WebSocket account" "$GREEN"
item 2 "Delete VMess WebSocket account" "$RED"
item 3 "Extend VMess account active life" "$YELLOW"
item 4 "Check VMess user login" "$CYAN"
item 5 "Renew VMess certificate" "$BLUE"
item 6 "Back to main menu" "$WHITE"
item 7 "Exit" "$RED"
footer 7
read -r menu
echo
