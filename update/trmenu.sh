...
header
box_title "TROJAN • XRAY"
system_info
item 1 "Create Trojan account" "$GREEN"
item 2 "Delete Trojan account" "$RED"
item 3 "Extend Trojan account active life" "$YELLOW"
item 4 "Check Trojan user login" "$CYAN"
