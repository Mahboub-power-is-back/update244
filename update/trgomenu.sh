...
box_title "TROJAN GO"
system_info
item 1 "Create Trojan-Go account" "$GREEN"
item 2 "Delete Trojan-Go account" "$RED"
item 3 "Extend Trojan-Go account active life" "$YELLOW"
item 4 "Check Trojan-Go user login" "$CYAN"
