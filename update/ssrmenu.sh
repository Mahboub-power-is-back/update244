...
header
box_title "SHADOWSOCKS-R"
system_info
item 1 "Create SSR account" "$GREEN"
item 2 "Delete SSR account" "$RED"
item 3 "Extend SSR account active life" "$YELLOW"
item 4 "Open SSR advanced menu" "$PURPLE"
