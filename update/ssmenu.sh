...
header
box_title "SHADOWSOCKS"
system_info
item 1 "Create Shadowsocks account" "$GREEN"
item 2 "Delete Shadowsocks account" "$RED"
item 3 "Extend Shadowsocks account active life" "$YELLOW"
item 4 "Check Shadowsocks user login" "$CYAN"
item 5 "Back to main menu" "$WHITE"
item 6 "Exit" "$RED"
footer 6
read -r menu
echo
