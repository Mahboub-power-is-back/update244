...
echo -e "Ssh Ws SSL    : 443 (/ssh-ws)"
echo -e "Ssh Ws No SSL : 80 (/ssh-ws)"
echo -e "Ovpn Ws       : 443, 80 (/ovpn-ws)"
...
echo -e "=============================="
echo -e "GET /ovpn-ws HTTP/1.1[crlf]Host: ${domain}[crlf]Upgrade: websocket[crlf][crlf]"
echo -e "=============================="
