...
DAEMON_OPTS="--user sslh \
  ...
  -n"
EOF
sed -i 's|ExecStart=.*|ExecStart=/usr/sbin/sslh -f $DAEMON_OPTS|' /lib/systemd/system/sslh.service
sed -i '/^\[Service\]/a Restart=on-failure' /lib/systemd/system/sslh.service
