...
server {
    ...
    location /vmess-xhttp/ {
        ...
        grpc_pass grpc://vmess_xhttp_none;
    }
    ...
    location /vless-xhttp/ {
        ...
        grpc_set_header Host $host;
        grpc_set_header X-Real-IP $remote_addr;
        grpc_pass grpc://vless_xhttp_none;
    }
    ...
    location /trojan-xhttp/ {
        ...
        grpc_set_header Host $host;
        grpc_set_header X-Real-IP $remote_addr;
        grpc_pass grpc://trojan_xhttp_none;
    }
    ...
    location /vmess-grpc {
        ...
        grpc_set_header Host $host;
        grpc_set_header X-Real-IP $remote_addr;
        grpc_pass grpc://vmess_grpc_none;
    }
    location /vless-grpc {
        client_max_body_size 0;
        client_body_buffer_size 512k;
        ...
        grpc_set_header Host $host;
        grpc_set_header X-Real-IP $remote_addr;
        grpc_pass grpc://vless_grpc_none;
    }
    location /trojan-grpc {
        ...
        grpc_set_header Host $host;
        grpc_set_header X-Real-IP $remote_addr;
        grpc_pass grpc://trojan_grpc_none;
    }
...
server {
    ...
    location /vmess-xhttp/ {
        ...
        grpc_set_header Host $host;
        grpc_set_header X-Real-IP $remote_addr;
        grpc_pass grpc://vmess_xhttp_tls;
    }
    ...
    location /vless-xhttp/ {
        ...
        grpc_set_header Host $host;
        grpc_set_header X-Real-IP $remote_addr;
        grpc_pass grpc://vless_xhttp_tls;
    }
    ...
    location /trojan-xhttp/ {
        ...
        grpc_set_header Host $host;
        grpc_set_header X-Real-IP $remote_addr;
        grpc_pass grpc://trojan_xhttp_tls;
    }
    ...
    location /trojan-grpc {
        ...
        grpc_set_header Host $host;
        grpc_set_header X-Real-IP $remote_addr;
        grpc_pass grpc://trojan_grpc_tls;
    }
    location / { root /home/vps/public_html; index index.html; }
}
NGINX
